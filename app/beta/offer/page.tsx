    ...
    <div className="max-w-3xl w-full px-6 py-12 bg-white shadow-xl rounded-2xl my-10">
      ...
      <div className="text-center mb-10">
        <h2 className="text-4xl font-extrabold text-gray-900 mb-4">
          Unlock Your OpenCart Store’s <span className="text-blue-600">Hidden Revenue</span>
        </h2>
      ...
      <div className="grid md:grid-cols-3 gap-6 text-center border-t pt-8">
        ...
        <div>
          <div className="text-3xl mb-2">🚀</div>
          <h3 className="font-bold text-gray-800">OpenCart Native</h3>
          <p className="text-sm text-gray-500">Built specifically for your store.</p>
        </div>
      </div>
